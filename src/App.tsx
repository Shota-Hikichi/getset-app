...
import NewsManager from "./pages/admin/pages/NewsManager";
import MeetingPage from "./pages/MeetingPage";
import { useTimeSettingsStore } from "./stores/useTimeSettingsStore";
...
const AuthWrapper: React.FC<AuthWrapperProps> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    if (currentUser) {
      ...
      useTimeSettingsStore.getState().loadFromFirestore(currentUser.uid);
    ...
    <div className="min-h-screen pb-16">
      <AuthWrapper>
        <Routes>
          ...
          <Route path="/mypage/time-settings" element={<TimeSettingsPage />} />
          <Route path="/mypage/meeting" element={<MeetingPage />} />
          <Route path="/mypage/news" element={<NewsPage />} />
          <Route path="/mypage/news/:id" element={<NewsDetailPage />} />
